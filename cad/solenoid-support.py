...
from common import M3Screw, SolenoidSupport, Solenoid, export_stl
...
solenoid_support = (
    cq.Workplane("XY")
    .rect(
        SolenoidSupport.screw_hole_separation + M3Screw.hole_buffer_diameter,
        SolenoidSupport.inner_diameter + SolenoidSupport.wall_thickness * 2,
    )
    ...
    .workplane()
    .circle(SolenoidSupport.inner_diameter / 2)
    .circle(SolenoidSupport.inner_diameter / 2 + SolenoidSupport.wall_thickness)
